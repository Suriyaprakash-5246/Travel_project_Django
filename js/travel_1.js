...
document.getElementById('signupBtn').onclick = function() {
  ...
  const attractions = {
    "Kerala": [
      { "name": "Munnar", "description": "Misty hills, tea plantations, waterfalls, and breathtaking panoramic views.", "image": "img/munnar.jpg" },
    ...
    "Assam": [
      { "name": "Kaziranga National Park", "description": "One-horned rhinos, lush greenery, wildlife safaris, and natural biodiversity.", "image": "img\kaziranga.jpg" },
